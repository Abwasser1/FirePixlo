...
public class ObsidianShovel extends CustomItem {

	@Override
	public NamespacedKey getNamespacedKey() {
		return new NamespacedKey(Main.getInstance(), "obsidian_shovel");
	}

	@Override
	public ItemStack getItem() {
		ItemStack is = itemBakery(Material.DIAMOND_SHOVEL, 100, "§rObsidian Shovel", 1, getNamespacedKey().getKey());
		return is;
	}
	@Override
